...
Route::get('/requestsengineer-pdf', [  PdfController::class, 'requestsengineer'])->name('requestsengineer-pdf');
Route::get('/engineer-pdf/{id}', [  PdfController::class, 'engineer'])->name('pdf.engineer');
Route::get('/team-pdf/{id}', [  PdfController::class, 'team'])->name('pdf.team');

Route::get('/delivery-note/{id}',[PurchaseController::class,'deliveryNote'])->name('delivery_note');

Route::get('/reports',[EngineerReportController::class,'index'])->name('report.index');
