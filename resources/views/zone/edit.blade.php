...
<div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Edit Zones</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Edit Zones</li>
                        </ol>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                        <form action="{{route('zone.update', $zone->id)}}" method="post">  
                                            ...
                                            <div class="mt-4 mb-0">
                                                <div class="d-grid"><button class="btn btn-primary btn-block"  type="submit">Update Zone</a></div>
                                            </div>
                                        </form>
                                    </div>
                        </div>
