...
@section('title')
<title>Approve Issuances</title>
@endsection
@section('content') 
<div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">  Approve Issuances</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Approve Issuances</li>
                        </ol>
                            ...
                            @endif
                                        <form action="{{route('request.update',  $request->id)}}" method="post">  
                                            ...
                                            <div class="mt-4 mb-0">
                                                ...
                                                <div class="d-grid"><button class="btn btn-primary btn-block"  type="submit">Approve Issuance</a></div>
                                            </div>
                                        </form>
                                    </div>
                        </div>
