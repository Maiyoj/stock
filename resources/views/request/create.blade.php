                    ...
                    <div class="container-fluid px-4">
                        ...
                        Request
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        <form id="add-item" action="{{route('request.add')}}" method="post">  
                                            @csrf
                                            <div class="row mb-3">
                                                <div class="col-md-12">
                                                    @if ($errors->any())
                                                ...
                                                <div class=" col-md-6 mt-4 mb-0">
                                                    <div class="d-grid"><a href="{{route('request.complete')}}" class="btn btn-primary">Complete Request</a></div>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <table class="table table-striped">
                                            ...
                                            <tbody>
                                                <?php $totalprice=0; ?>
                                                @foreach (Session::get('request') as $id => $item)
                                                    @foreach ($items as $itm)
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>{{$itm->name}}</td>
                                                            <td>{{$item['quantity']}}</td>
                                                            <td><a href="{{route('request.remove',$itm->id)}}"><i class="fa fa-trash text-danger"></i></a></td>
                                                        </tr>
                                                        @endif
                                                    @endforeach
                                                @endforeach
