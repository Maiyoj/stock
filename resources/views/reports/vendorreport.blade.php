...
<div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Vendors Report</h1>
                                   ...
                                   <div class="col-sm-2 col-md-1 ">
                                    ...
                                    <div class="col-sm-4 col-md-2 ">
                                        <div class="form-group form-focus">
                                            ...
                                            <div class="">
                                                <a href="/vendors-reports?print=yes" class="btn btn-red"><i class="fa fa-print fa-lg text-success fa-2x"></i> Print</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="table-responsive">
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                     ...
                                     <td>
                                        <a href="{{route('reports.itemreport',$vendor->id)}}" class="text-primary"><i class="fa fa-eye fa-2x"></i> </a>
                                     </td>
                                            </tr>                                                           
                                        @empty
