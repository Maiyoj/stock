...
@section('title')
<title>Issuances Reports</title>
@endsection
@section('content') 
<div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                      <h1 class="mt-4">Issuances Reports</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active"> Issuances Reports</li>
                        </ol>
                                   ...
                                   <div class="col-sm-2 col-md-1 ">
                                    ...
                                    <div class="col-sm-4 col-md-2 ">
                                        <div class="form-group form-focus">
                                            ...
                                            <div class="">
                                                <a href="/issuances-reports?print=yes" class="btn btn-red"><i class="fa fa-print fa-lg text-success fa-2x"></i> Print</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$issuance->quantity}}</td>
                                             ...
                                             <td>
                                                <a href="{{route('reports.issuancereport',$insuance->id)}}" class="text-primary"><i class="fa fa-eye fa-2x"></i> </a>
                                            </td>
